...
$ http://127.0.0.1:8888/admin/ {To create your blog articles} $ http://127.0.0.1:8888/blog/ {To view your blog articles}

FEATURES: -Search -Comment Section -Posts Count -RSS feed
...
NOTICE: This blog app runs under PostgreSQL database. Install it.
